		...
		<header class="profile__header">
			...
			<div class="profile__info">
				...
				<ul class="profile__stats">
					<li class="profile__stat"><span class="profile__stat-number">${imageCount }</span> posts</li>
					<li class="profile__stat"><span class="profile__stat-number">${followerCount }</span><a
						href="/follow/follower/${user.id }"> followers</a></li>
					<li class="profile__stat"><span class="profile__stat-number">${followCount }</span><a
						href="/follow/follow/${user.id }"> following</a></li>
				</ul>
				<p class="profile__bio">
					<span class="profile__fullname">${user.name }</span> ${user.bio } <a href="${user.website }"
						class="profile__link">${user.website }</a>
				</p>
			</div>
		</header>
